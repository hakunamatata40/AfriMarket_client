...
% ============================================================
%  SOMMAIRE (version courte — 1 seul niveau, juste après la page de titre)
%  Le sommaire liste uniquement les chapitres et les grandes parties,
%  contrairement à la table des matières complète placée en fin de document.
% ============================================================
{
  % On limite temporairement la profondeur à 1 (chapitres seulement)
  \setcounter{tocdepth}{1}
  \renewcommand{\contentsname}{Sommaire}
  \tableofcontents
  \addcontentsline{toc}{chapter}{Sommaire}   % le sommaire se référence lui-même
}
% On remet la profondeur complète pour la table des matières finale
\setcounter{tocdepth}{3}
...
% ============================================================
%  LISTE DES ABRÉVIATIONS (générée automatiquement par le package glossaries)
%  Pour que cette liste se remplisse :
%    1. Chaque abréviation est déclarée avec \newacronym{clé}{SIGLE}{Développement}
%       dans le préambule (section "DÉFINITION DES ACRONYMES" ci-dessus)
%    2. Elle doit être utilisée avec \gls{clé} ou \acrshort{clé} dans le texte
%    3. Il faut exécuter "makeglossaries rapport_AfriMarket" entre les passes pdflatex
%       (TeXstudio le fait automatiquement ; en ligne de commande : voir ci-dessous)
%
%  Commande de compilation complète :
%    pdflatex rapport_AfriMarket
%    makeglossaries rapport_AfriMarket
%    bibtex rapport_AfriMarket
%    pdflatex rapport_AfriMarket
%    pdflatex rapport_AfriMarket
% ============================================================
\printglossary[
  type=\acronymtype,          % affiche uniquement les acronymes (pas le glossaire)
  title={Liste des Abréviations},
  toctitle={Liste des Abréviations},
  style=long,                 % style en tableau 2 colonnes : SIGLE — Développement
  nopostdot                   % pas de point final après chaque entrée
]
...
% ============================================================
%  TABLE DES MATIÈRES COMPLÈTE (placée en fin de document)
%  Contrairement au Sommaire (début, 1 niveau), cette table est
%  exhaustive : elle liste tous les chapitres, sections et sous-sections.
%  Elle se génère automatiquement à partir de tous les \chapter,
%  \section, \subsection, \subsubsection présents dans le document.
% ============================================================
\clearpage
\renewcommand{\contentsname}{Table des matières}
\setcounter{tocdepth}{3}   % profondeur complète : jusqu'aux \subsubsection
\tableofcontents
